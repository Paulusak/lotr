...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rIrzvlHpii', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mD0hFToEe+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CollectionOfUserRepository' => ['privates', 'App\\Repository\\CollectionOfUserRepository', 'getCollectionOfUserRepositoryService', true],
            ...
            'App\\Repository\\RarityRepository' => ['privates', 'App\\Repository\\RarityRepository', 'getRarityRepositoryService', true],
            'App\\Repository\\SetRepository' => ['privates', 'App\\Repository\\SetRepository', 'getSetRepositoryService', true],
            'App\\Repository\\StateOfCardRepository' => ['privates', 'App\\Repository\\StateOfCardRepository', 'getStateOfCardRepositoryService', true],
            'App\\Repository\\UserCardRepository' => ['privates', 'App\\Repository\\UserCardRepository', 'getUserCardRepositoryService', true],
            'App\\Repository\\UserForgottenPasswordRepository' => ['privates', 'App\\Repository\\UserForgottenPasswordRepository', 'getUserForgottenPasswordRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YHUMEsO2JC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1tKEeXm7RL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vBdKfj8pr-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gd1AXkl451', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o6jfUTzt5u', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RqE2-USXWb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['router.request_context'] = $instance = \Symfony\Component\Routing\RequestContext::fromUri('', $this->getEnv('REQUEST_CONTEXT_HOST'), $this->getEnv('REQUEST_CONTEXT_SCHEME'), 80, 443);
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'router.request_context.host': $value = $this->getEnv('REQUEST_CONTEXT_HOST'); break;
            case 'router.request_context.scheme': $value = $this->getEnv('REQUEST_CONTEXT_SCHEME'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'twig.form.resources' => [
                ...
                1 => '@TetranzSelect2Entity/Form/fields.html.twig',
            ],
